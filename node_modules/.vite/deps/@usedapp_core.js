import {
  ...
  lib_exports,
  utils_exports
} from "./chunk-S4A3NZUU.js";
import {
  require_utils
} from "./chunk-2Q357TN6.js";
import "./chunk-3Q7RA6RT.js";
import {
  require_react
...
import "./chunk-N2WLDW6X.js";
import "./chunk-F5OVKFB2.js";
import {
  __commonJS,
  __export,
  __toESM
...
function ConfigProvider({ config, children }) {
  const configWithDefaults = Object.assign(Object.assign(Object.assign({}, DEFAULT_CONFIG), (0, import_lodash2.default)(config, noUndefined)), { notifications: Object.assign(Object.assign({}, DEFAULT_CONFIG.notifications), (0, import_lodash2.default)(config.notifications, noUndefined)) });
...
async function estimateTransactionGasLimit(transactionRequest, signer, bufferGasLimitPercentage) {
...
async function estimateContractFunctionGasLimit(contractWithSigner, functionName, args, bufferGasLimitPercentage) {
  try {
...
function useContractFunction(contract, functionName, options) {
  ...
  const bufferGasLimitPercentage = (options === null || options === void 0 ? void 0 : options.bufferGasLimitPercentage) || (config === null || config === void 0 ? void 0 : config.bufferGasLimitPercentage) || 0;
  const providers = useReadonlyNetworks();
