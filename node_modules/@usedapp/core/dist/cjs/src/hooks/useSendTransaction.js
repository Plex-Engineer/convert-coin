...
function useSendTransaction(options) {
    ...
    var _b = (0, usePromiseTransaction_1.usePromiseTransaction)(transactionChainId, options), promiseTransaction = _b.promiseTransaction, state = _b.state, resetState = _b.resetState;
    var config = (0, useConfig_1.useConfig)();
    var bufferGasLimitPercentage = (options === null || options === void 0 ? void 0 : options.bufferGasLimitPercentage) || (config === null || config === void 0 ? void 0 : config.bufferGasLimitPercentage) || 0;
